    ...
    <div class="faq-container">
      ...
      <div class="faq-answer ">
        <div class="faq-answer-content">
          ...
          <form method="POST" action="goverform.php">
           <select name="round" class="form-control">

            <option value="1">調查一</option>
    ...
    <div class="faq-container">
      ...
      <div class="faq-answer ">
        <div class="faq-answer-content">
          <div class='input-control'>
           說明國家發展決策
          <textarea rows="3" cols="1" id='x' type='text' class='input-control__input' placeholder=' ' name="type4" /></textarea>
        </div>
...
{  
 ...
 $sql="INSERT INTO goverform(id,location,type,text1,round,createtime,profession,country,type2,DO,BOD5,SS,NH3N,RPI,text2,type3,text3,type4) values ('".$_SESSION['id']."','$location','$type','$text1','$round',now(),'".$_SESSION['profession']."','".$_SESSION['country']."','$type2','$DO','$BOD5','$SS','$NH3N','$RPI','$text2','$type3','$text3','$type4')";
  $query=$conn->query($sql);
  ?>
        <script>
        window.alert('送出成功，歡迎!');
        window.location.href='goverform1.php';  
        </script>
      <?php
