    ...
    <div class="faq-container">
      ...
      <div class="faq-answer ">
        <div class="faq-answer-content">
          ...
          <form method="POST" action="busform1.php">
          ...
          <div class='input-control'>
            <textarea rows="10" cols="20"  id='x' type='text' class='input-control__input' placeholder=' ' name="text1" /></textarea>
...
{  
 ...
 $sql="INSERT INTO busform1(id,location,type,text1,round,createtime,profession,country,type2,DO,BOD5,SS,NH3N,RPI,text2,type3,text3,type4) values ('".$_SESSION['id']."','$location','$type','$text1','$round',now(),'".$_SESSION['profession']."','".$_SESSION['country']."','$type2','$DO','$BOD5','$SS','$NH3N','$RPI','$text2','$type3','$text3','$type4')";
  $query=$conn->query($sql);
  ?>
  <script>
    window.alert('送出成功，歡迎!');
    window.location.href='busform2.php';  
  </script>
  <?php
