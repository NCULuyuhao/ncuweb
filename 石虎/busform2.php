    ...
    <div class="faq-container">
      ...
      <div class="faq-answer ">
        <div class="faq-answer-content">
          ...
          <form method="POST" action="busform2.php">
...
$sql="INSERT INTO busform2(id,location,type,text1,round,createtime,profession,country,type2,DO,BOD5,SS,NH3N,RPI,text2,type3,text3,type4) values ('".$_SESSION['id']."','$location','$type','$text1','$round',now(),'".$_SESSION['profession']."','".$_SESSION['country']."','$type2','$DO','$BOD5','$SS','$NH3N','$RPI','$text2','$type3','$text3','$type4')";
