    ...
    <div class="faq-container">
      ...
      <div class="faq-answer ">
        <div class="faq-answer-content">
          ...
          <form method="POST" action="conform1.php">
           <select name="round" class="form-control">

            <option value="1">保育二</option>

          </select>
          <select name="location" class="form-control">
            <option>選擇保育地點</option>
          ...
          <select name="type" class="form-control">
            <option>要保育甚麼呢?</option>
            <option value="動物">動物</option>
            <option value="植物">植物</option>
            <option value="水汙染">水汙染</option>
...
{  
 ...
 $sql="INSERT INTO conform1(id,location,type,text1,round,createtime,profession,country,type2,DO,BOD5,SS,NH3N,RPI,text2,type3,text3,type4) values ('".$_SESSION['id']."','$location','$type','$text1','$round',now(),'".$_SESSION['profession']."','".$_SESSION['country']."','$type2','$DO','$BOD5','$SS','$NH3N','$RPI','$text2','$type3','$text3','$type4')";
  $query=$conn->query($sql);
  ?>
  <script>
    window.alert('送出成功，歡迎!');
    window.location.href='conform2.php';  
  </script>
  <?php
